...
|---------|-------------|------------|
| **Parcel Booking Platform** | Booking system with Google Maps integration, favorite locations feature | React.js, Node.js, Google Maps API, Jest |
| **POS Banking Services** | Financial services module for cash withdrawal & account registration | React.js, EDC Integration, API Development |
| **Legacy Modernization** | Migration from PHP/Java to modern React.js & Node.js stack | React.js, Vue.js, Node.js, Express |
